...
{{
    ...
    {{
        ...
        {{
            ...
            {{
                ...
                {{
                    ...
                    {{
                        Process.Start("http://jq.qq.com/?_wv=1027&k=SOAZo0");
        ...
        {{
            Config = new Menu("【無為汉化】:  + Player.ChampionName, Player.ChampionName, true);
            Config.AddSubMenu(new Menu("走砍", Orbwalking"));
            SimpleTS.AddToMenu(Config.AddSubMenu(new Menu("目标选择器", Target Selector")));
        ...
        ///     SupportSimpleTS
        /// </summary>
        public SimpleTS SimpleTS {{ get; set; }
        ...
        {{
            get {{ return SimpleTS.GetTarget(SpellRange, SimpleTS.DamageType.Magical); }
        }
