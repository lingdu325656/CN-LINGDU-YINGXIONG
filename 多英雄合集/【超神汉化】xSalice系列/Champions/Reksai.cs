    ...
    {{
        ...
        {{
            ...
            {{
                ...
                combo.AddItem(new MenuItem("UseQCombo", 使用全部Q").SetValue(true));
                combo.AddItem(new MenuItem("Q_Reset", Q自动重置攻击").SetValue(true));
                combo.AddItem(new MenuItem("UseWCombo", 使用W").SetValue(true));
                combo.AddItem(new MenuItem("UseECombo", 使用地表E").SetValue(true));
                combo.AddItem(new MenuItem("Ignite", 使用点燃").SetValue(true));
                combo.AddItem(new MenuItem("Use_Item", 使用物品").SetValue(true));
                //add to menu
            ...
            {{
                ...
                drawMenu.AddItem(new MenuItem("Draw_CD", 显示冷却").SetValue(true));
        ...
        {{
            ...
            if (_barrowed)
            {{
                var target = SimpleTS.GetTarget(250, SimpleTS.DamageType.Physical);
