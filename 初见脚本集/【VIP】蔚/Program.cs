...
namespace Vi
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            comboUseQ.AddItem(new MenuItem("UseQComboDontUnderTurret", "在塔下不使用Q").SetValue(true));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("HarassMana", "Min.法力值: ")
            ...
            Config.SubMenu("JungleFarm").AddItem(new MenuItem("JungleFarmMana", "Min.法力值: ")
                .SetValue(new Slider(50, 100, 0)));
            ...
            MenuTargetedItems.AddItem(new MenuItem("item3143", "兰顿之兆").SetValue(true));
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("RRange", "R 范围").SetValue(new Circle(false,
                System.Drawing.Color.FromArgb(255, 255, 255, 255))));
            Config.SubMenu("Drawings").AddItem(new MenuItem("SmiteRange", "惩戒范围").SetValue(new Circle(false,
                System.Drawing.Color.FromArgb(255, 255, 255, 255))));
            ...
            Game.PrintChat(
                String.Format(
                    "<font color='#70DBDB'>xQx |钄殀 </font> <font color='#FFFFFF'>{0}</font> <font color='#70DBDB'> 鍒濊姹夊寲 QQ藟5011477  鍔犺浇鎴愬姛!</font>",
                    ChampionName));
