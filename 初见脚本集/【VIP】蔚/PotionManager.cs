...
namespace Vi
{
    internal class PotionManager
    {
        ...
        private void Load()
        {
            ...
            Program.MenuExtras.AddSubMenu(new Menu("药水", "PotionManager"));
            ...
            Program.MenuExtras.SubMenu("PotionManager").SubMenu("Health").AddItem(new MenuItem("HealthPercent", "HP多少使用").SetValue(new Slider(30)));
            ...
            Program.MenuExtras.SubMenu("PotionManager").SubMenu("Mana").AddItem(new MenuItem("ManaPercent", "MP多少使用").SetValue(new Slider(30)));
