...
namespace FioraRaven
{
    class Fiora
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu = new Menu("|初见汉化-剑姬|","Fiora",true);
            menu.AddSubMenu(new Menu("|初见汉化-走砍|","Orbwalker1"));
            ...
            menu.AddSubMenu(new Menu("|初见汉化-物品|", "Item"));
            ...
            menu.AddSubMenu(new Menu("|初见汉化-自动躲避危险法术|", "DangSpells"));
