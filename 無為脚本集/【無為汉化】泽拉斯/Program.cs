...
{{
    ...
    {{
        ...
        {{
            ...
            if (SimpleTS.SelectedTarget.IsValidTarget() && !SimpleTS.IsInvulnerable(SimpleTS.SelectedTarget, SimpleTS.DamageType.Magical, true) &&
            ...
            {{
                if (!hero.IsValidTarget(R.Range) || SimpleTS.IsInvulnerable(hero, SimpleTS.DamageType.Magical, true) || Game.CursorPos.Distance(hero.ServerPosition) > distance)
                {{
                    continue;
                }
