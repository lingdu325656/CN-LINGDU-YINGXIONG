...
namespace TAC_Kalista
{
    class FightHandler
    {
        ...
        public static void OnCombo()
        {
            ...
            {
                customQCast(TargetSelector.GetTarget(SkillHandler.Q.Range, TargetSelector.DamageType.Physical));
            }
            ...
            if (SkillHandler.E.IsReady())
                MathHandler.castMinionE(TargetSelector.GetTarget(SkillHandler.E.Range, TargetSelector.DamageType.Physical));
        }
        public static void OnHarass()
        {
            Obj_AI_Hero target = TargetSelector.GetTarget(SkillHandler.E.Range, TargetSelector.DamageType.Physical);
