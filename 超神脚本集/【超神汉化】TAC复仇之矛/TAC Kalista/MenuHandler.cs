...
{{
    ...
    {{
        ...
        {{
            Config = new Menu("【超神汉化】复仇之矛", Kalista", true);

            var SimpleTSmenu = new Menu("目标选择", Common_SimpleTS");
...
//            Config.SubMenu("ac").SubMenu("itemsAC").AddItem(new MenuItem("allInAt", Auto All in when X hero").SetValue(new Slider(2, 1, 5)));
            ...
            Config.SubMenu("System").AddItem(new MenuItem("QSystem", L#汉化群：386289593").SetValue(true));
