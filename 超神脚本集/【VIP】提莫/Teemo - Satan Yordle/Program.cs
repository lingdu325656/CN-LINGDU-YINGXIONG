...
namespace Teemo___Satan_Yordle
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Base menu
            Menu = new Menu("【初见汉化】提莫", "Teemo Satan Yordle", true);

            //SimpleTs
            Menu.AddSubMenu(new Menu("[初见汉化] - 目标选择器", "Target Selector"));
            SimpleTs.AddToMenu(Menu.SubMenu("Target Selector"));

            //Orbwalker
            Menu.AddSubMenu(new Menu("[初见汉化] - 走砍", "Orbwalker"));
            ...
            //Harass
            Menu.AddSubMenu(new Menu("[初见汉化] - 骚扰", "Harass"));
            ...
            //R settings
            Menu.AddSubMenu(new Menu("[初见汉化] - R设置", "Rsettings"));
