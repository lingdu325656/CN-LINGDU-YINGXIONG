...
namespace SephKhazix
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //config
            Config.AddSubMenu(new Menu("自动Poke", "autopoke"));
            Config.SubMenu("autopoke").AddItem(new MenuItem("AutoHarrass", "自动Poke")).SetValue(true);
            Config.SubMenu("autopoke").AddItem(new MenuItem("AutoWI", "自动W不动的")).SetValue(true);
            Config.SubMenu("autopoke").AddItem(new MenuItem("AutoWD", "自动W")).SetValue(true);


            //
            Config.AddSubMenu(new Menu("封包", "Packets"));
            Config.SubMenu("Packets").AddItem(new MenuItem("usePackets", "封包").SetValue(true));
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseEGapclose", "使用E突进后Q")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseEGapcloseW", "使用E突进后W")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRGapcloseW", "长距离突进使用R")).SetValue(true);
            ...
            Config.SubMenu("Farm").AddItem(new MenuItem("UseQFarm", "使用Q")).SetValue(true);
            Config.SubMenu("Farm").AddItem(new MenuItem("UseEFarm", "使用E")).SetValue(false);
            Config.SubMenu("Farm").AddItem(new MenuItem("UseWFarm", "使用W")).SetValue(true);
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("ActiveFarm", "补兵").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("JungleFarm", "清野").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));
            ...
            Config.SubMenu("Ks").AddItem(new MenuItem("UseWKs", "使用W")).SetValue(true);
            Config.SubMenu("Ks").AddItem(new MenuItem("UseEKs", "使用E")).SetValue(true);
            Config.SubMenu("Ks").AddItem(new MenuItem("UseEQKs", "使用EQ")).SetValue(true);
            Config.SubMenu("Ks").AddItem(new MenuItem("UseEWKs", "使用EW")).SetValue(false);
            ...
            Config.SubMenu("Debug").AddItem(new MenuItem("Debugon", "调试").SetValue(true));
